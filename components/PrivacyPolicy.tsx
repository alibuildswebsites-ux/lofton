      ...
      <main className="pt-32 pb-20 md:pt-40 md:pb-28">
        <div className="max-w-4xl mx-auto px-5 md:px-10">
          <div className="bg-background p-8 md:p-12 rounded-3xl shadow-sm border border-border">
            <h1 className="text-3xl md:text-5xl font-extrabold text-foreground mb-4">Privacy Policy</h1>
            ...
            <div className="space-y-8 text-muted-foreground leading-relaxed text-lg">
              ...
              <section>
                <h2 className="text-2xl font-bold text-foreground mb-4">4. Data Protection & Security</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-foreground mb-4">6. Cookies & Third-Party Tools</h2>
                <p>
