  ...
  return (
    <div className="flex flex-col min-h-screen bg-accent">
      ...
      <div className="flex-grow flex flex-col items-center justify-center text-center px-4 pt-32 pb-20">
        ...
        <Link 
          to="/"
          className="flex items-center gap-2 bg-foreground text-background px-8 py-3.5 rounded-full font-bold hover:bg-black transition-all shadow-lg hover:shadow-xl"
        >
          <Home size={20} />
          Return Home
        </Link>
