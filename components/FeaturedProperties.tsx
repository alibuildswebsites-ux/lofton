...
export const FeaturedProperties = () => {
  ...
  return (
    <section ref={sectionRef} className="py-[60px] md:py-[80px] lg:py-[100px] bg-accent" id="properties">
      <div className="max-w-[1280px] mx-auto px-5 md:px-10 lg:px-[40px]">
        <div className="flex justify-between items-end mb-[40px] md:mb-[60px]">
          ...
          <Link 
            ...
            className="hidden md:flex items-center gap-2 text-foreground font-bold hover:text-brand transition-colors rounded-lg px-2 py-1 -ml-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2"
          >
