    ...
    <div className="font-sans bg-accent min-h-screen">
      ...
      <main className="pt-32 pb-20 md:pt-40 md:pb-28">
        <div className="max-w-4xl mx-auto px-5 md:px-10">
          <div className="bg-background p-8 md:p-12 rounded-3xl shadow-sm border border-border">
            <h1 className="text-3xl md:text-5xl font-extrabold text-foreground mb-4">Terms of Service</h1>
            <p className="text-muted-foreground mb-8 font-medium">Last Updated: October 26, 2023</p>
            ...
            <div className="space-y-8 text-muted-foreground leading-relaxed text-lg">
              ...
              <section>
                <h2 className="text-2xl font-bold text-foreground mb-4">2. Use of the Site</h2>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-foreground mb-4">4. User Submissions</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-foreground mb-4">9. Changes to the Terms</h2>
                <p>
